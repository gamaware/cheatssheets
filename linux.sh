...
# Show which version of Linux is installed
cat /etc/*release
lsb_release -a
hostnamectl
cat /etc/issue
...
#Display the percentage of memory that's free
...
# Display last 50 lines of the alertlog and filter by ORA errors
tail -50 alert_pribsp12.log | egrep "12012|04045|04052|00604|01089|02063" 
...
# Find and list large files in the filesystem
find . -size +100000000c  -exec ls -ltrh {} \;

# Find specific file and compress it
find . -type f -name "EMGC_ADMINSERVER.out" -exec gzip -vf {} \;
'-------------------------------------------------------
12 - SSH LOGINS'
...
du -sh *
du -sh * 2>/dev/null 
du --max-depth=1 --one-file-system -h $@ |grep -v K;
